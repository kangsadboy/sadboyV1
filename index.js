const  XBOT = 'RAMA SADBOY'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/yes_gwsalah'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+6285355566000'; // Nomor whatsapplu cok
const aktif = 'Tergantung kuota'; // Kapan bot lu aktif
const groupwa = 'comming soon'; // OFFICIAL GRUP LU 1
const youtube = 'https://youtube.com/channel/UCwfwi88U0QMOb42R1SgxH7A'; 
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6285355566000:+62 895-3555-660005\n' // WhatsApp ID + phone number
            + 'END:VCARD'
